...
const Card = ({ event, hasOrderLink, hidePrice }: CardProps) => {
  ...
  return (
    <div
      className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md
    ...
    >
      ...
      <div className="flex min-h-[230px] flex-col gap-3 p-5 md:gap-4">
        ...
        <Link className="flex-1" href={`/events/${event._id}`}>
